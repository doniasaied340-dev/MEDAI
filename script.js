...
(function () {
  ...
  // =========================================================
  // index.html — save patient name, continue to index
  // =========================================================
  ...
  // =========================================================
  // dynamic patient name display (home.html / status.html)
  // =========================================================
  ...
  // =========================================================
  // home.html — render any newly onboarded medications
  // =========================================================
  ...
  if (statusList) {
    getMeds().forEach(function (med) {
      ...
      photoWrap.className = "status-row__photo-wrap";
      var photo = document.createElement("img");
      photo.className = "status-row__photo";
      photo.src = med.photo || "assets/images/pill-generic-white.png";
      photo.alt = med.name || "";
      var badge = document.createElement("img");
      badge.className = "status-row__badge";
      badge.src = "assets/icons/status-pending.png";
      badge.alt = "";
  ...
  // =========================================================
  // "סימון כנלקח" confirm button (home.html)
  ...
  // =========================================================
  // "דחייה / תזכורת מאוחר יותר" snooze button (home.html)
  ...
  var snoozePopup = document.getElementById("snooze-popup");
  var snoozePopupClose = document.getElementById("snooze-popup-close");
  if (snoozeBtn) {
    snoozeBtn.addEventListener("click", function () {
      ...
      if (snoozePopup) snoozePopup.removeAttribute("hidden");
    });
  }
  if (snoozePopupClose && snoozePopup) {
    snoozePopupClose.addEventListener("click", function () {
      snoozePopup.setAttribute("hidden", "");
    });
  }
  ...
  if (continueBtn) {
    continueBtn.addEventListener("click", function () {
      ...
      window.location.href = continueBtn.dataset.next || "home.html";
    });
  }
  ...
  if (currentPage === "onboarding-3") {
    ...
    if (saveMedBtn) {
      saveMedBtn.addEventListener("click", function () {
        ...
        clearDraft();
        window.location.href = saveMedBtn.dataset.next || "home.html";
      });
    }
  }
